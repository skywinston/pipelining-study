...
// begins with L
function nAmerica(obj){
  return obj.country==="US" || obj.country==="United States" || obj.country === "CAN" || obj.country === "Canada";
}

function firstName(obj, firstLetter){
  return obj.firstName.charAt(0) === firstLetter;
}

var test1 = people.filter(function(person){
  return nAmerica(person) && firstName(person, "L");
}).map(function(person){
...
var test2 = people.filter(function(person){
  return person.age > 60;
}).map(function(person){
  if(person.country==="US" || person.country==="United States"){
    person.country = "United States";
  } else if (person.country==="England" || person.country==="UK"){
    person.country = "England";
  } else if (person.country==="IRL" || person.country === "Ireland"){
    person.country = "Ireland";
  } else if (person.country==="CAN" || person.country === "Canada"){
...
var countryCount = people.map(function(person){
  if(person.country==="US" || person.country==="United States"){
    person.country = "United States";
  } else if (person.country==="England" || person.country==="UK"){
    person.country = "England";
